...
// $ go test -benchmem -run=^$ -bench ^(BenchmarkPopCount)$ gopl.io/ch2/popcount
...
// Go 1.16 linux/amd64
// $ go test -bench=. gopl.io/ch2/popcount
// goos: linux
// goarch: amd64
// pkg: gopl.io/ch2/popcount
// cpu: Intel(R) Core(TM) i7-1065G7 CPU @ 1.30GHz
// BenchmarkPopCount-8                     1000000000               0.3920 ns/op
// BenchmarkBitCount-8                     1000000000               0.3985 ns/op
// BenchmarkPopCountByClearing-8           77722357                15.09 ns/op
// BenchmarkPopCountByShifting-8           36465518                32.54 ns/op
// PASS
// ok      gopl.io/ch2/popcount    5.087s
